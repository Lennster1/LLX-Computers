		...
		<div class="wp-block-column is-vertically-aligned-stretch" style="padding-right:0;flex-basis:60%">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<figure class="wp-block-image size-large is-style-rounded">
					<img src="./<br />_<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_url() in C:\laragon\www\wp-content\themes\twentytwentyfour\patterns\gallery-project-layout.php:20_Stack trace:_#0 {main}_  thrown in <b>C:\laragon\www\wp-content\themes\twentytwentyfour\patterns\gallery-project-layout.php</b> on line <b>20</b><br />"></figure>
</div>
</div>
</div>
</div>