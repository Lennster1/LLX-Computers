	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%">
			...
			<figure class="wp-block-image size-full is-style-rounded">
				<img src="./<br />_<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_url() in C:\laragon\www\wp-content\themes\twentytwentyfour\patterns\cta-services-image-left.php:18_Stack trace:_#0 {main}_  thrown in <b>C:\laragon\www\wp-content\themes\twentytwentyfour\patterns\cta-services-image-left.php</b> on line <b>18</b><br />"></figure>
</div>
</div>
</div>